  ...
  return (
    <div className="filter-sidebar-main">
      ...
      <div className="filter-header">
        <li className="mb-0">
          <div className="body-head text-center">
            <h6 className="mb-0 text-dark text-uppercase">Filter By</h6>
      ...
      <div className="filter-header mb-2">
        ...
        >
          <div className="body-head d-flex justify-content-between align-items-center">
            <h6 className="mb-0 text-dark">Types</h6>
            <h6 className="mb-0">
              <i
                className={`fas ${
                  openSections.productType ? "fa-angle-up" : "fa-angle-right"
                }`}
              ></i>
            </h6>
          </div>
        ...
        <div className="collapse" id="productType">
          {productTypes.map((item, index) => (
            <li className="mb-2" key={index}>
              <button className="filter-btn mx-auto">
        ...
        <div className="collapse" id="size">
          <div className="sizes">
            {sizes.map((item, index) => (
              <li className="mb-2" key={index}>
                <button className="size-btn mx-auto">
                  <span>{item.size}</span>
                </button>
              </li>
            ))}
